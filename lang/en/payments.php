...
return [
    ...
    'invalid_phone_format'  => 'Enter phone in international format, e.g. +25655550100.',
    'sms' => 'SMS',
    'enter_customer_phone' => 'Enter Customer Phone Number',
    'no_phone_on_file_please_add' => 'No phone number added',
    ...
    'leave_empty_for_all_locations' => 'Leave empty for all locations',
    'select_locations' => 'Select Locations',
    'select_one_or_more_locations_where_this_payment_method_is_available' => 'Select one or more locations where this payment method is available',
    'locations' => 'Locations',
    ...
    'discount_amount_hint' => 'Enter the discount amount to subtract from the invoice total',
    'discount_notes' => 'Discount Notes',
    'enter_discount_reason' => 'Enter reason for discount (e.g., "Bulk purchase discount")',
    'discount_already_applied' => 'A discount is already applied to this invoice',
    'applying_new_discount_will_replace' => 'Applying a new discount will replace the existing one',
    'remove_discount' => 'Remove Discount',
    'enter_valid_discount' => 'Please enter a valid discount amount',
    'discount_cannot_be_zero' => 'Discount cannot be zero. Enter a value greater than 0.',
    'discount_applied' => 'Discount of :amount applied successfully',
    'discount_removed' => 'Discount removed successfully',
    'discount_apply_failed' => 'Failed to apply discount. Please try again.',
    'discount_remove_failed' => 'Failed to remove discount. Please try again.',
    'confirm_remove_discount' => 'Are you sure you want to remove the discount from this invoice?',
    'no_discount_to_remove' => 'No discount to remove from this invoice.',
    'cannot_discount_sent_invoice' => 'Cannot discount an invoice that has already been sent.',
    'cannot_modify_sent_invoice' => 'Cannot modify an invoice that has already been sent.',
    'current_discount' => 'Current Discount',
    'discount_exceeds_subtotal' => 'Discount cannot exceed the subtotal amount.',
    ...
    'confirm_transfer_message'       => 'Are you sure you want to proceed with this transfer?',
    'yes_transfer'                   => 'Yes, Transfer',
    'transfer_completed'             => 'Funds transferred successfully.',
    ...
    'reference'                      => 'Reference',
    'will_exceed_balance' => 'This amount exceeds the current balance',
    'locked'                         => 'Locked',
    'select_destination_account'     => 'Select destination account',
    'destination_must_differ'        => 'Destination account must be different from source.',
    'network_error'                  => 'Network error. Please try again.',
    'transfer_between_payment_methods' => 'Transfer Between Payment Methods',
    '_transfer'                      => 'Transfer',
