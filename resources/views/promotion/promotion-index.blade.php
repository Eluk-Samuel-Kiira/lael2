                ...
                <div class="w-100 w-sm-250px">
                    <div class="input-group input-group-solid">
                        ...
                        <input type="text" 
                               ...
                               placeholder="{{__('auth._search')}} {{__('pagination._promotion')}}"
                               onkeyup="searchTable(this.value, 'kt_table_users')">
                    </div>
                </div>

                @can('create promotion')
                    <button type="button" class="btn btn-primary flex-shrink-0" data-bs-toggle="modal" data-bs-target="#kt_modal_add_promotion">
                        <i class="ki-duotone ki-plus fs-2 me-2 me-sm-3"></i>
                        <span class="d-none d-sm-inline">{{__('pagination.new_promotion')}}</span>
