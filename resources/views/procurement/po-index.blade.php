                ...
                <div class="w-100 w-sm-250px">
                    <div class="input-group input-group-solid">
                        ...
                        <input type="text" 
                               ...
                               placeholder="{{__('auth._search')}} {{__('passwords.purchase_order')}}"
                               onkeyup="searchTable(this.value, 'kt_table_users')">
                    </div>
                </div>

                @can('create tax')
                <button type="button" class="btn btn-primary flex-shrink-0" data-bs-toggle="modal" data-bs-target="#kt_modal_add_purchase_order">
                    <i class="ki-duotone ki-plus fs-2 me-2 me-sm-3"></i>
                    <span class="d-none d-sm-inline">{{__('passwords.new_purchase_order')}}</span>
