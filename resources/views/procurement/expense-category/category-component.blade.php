                ...
                @if (!empty($expense_categories) && $expense_categories->count() > 0)
                    @foreach ($expense_categories as $category)
                        <tr data-role="{{ strtolower($category->name) }}">
                            ...
                            <td>{{ $category->name }}</td>
                            <td>
                                <div class="badge badge-light fw-bold">{{ $category->code ?? __('pagination._none')}}</div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    @can('edit category-expense')
                                        <button 
                                            ...
                                            data-bs-target="#editExpCategory{{$category->id}}">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" id="deleteButton{{$category->id}}" class="btn btn-danger" 
                                                    data-item-url="{{ route('expense-category.destroy', $category->id) }}" 
                                ...
                                @include('procurement.expense-category.edit-category')
