                                ...
                                <form method="GET" action="{{ route('reports.purchasing.payment-status') }}" id="filterForm">
                                    <div class="d-flex flex-column flex-xl-row gap-4 gap-xl-6 flex-wrap mb-4">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <select class="form-select w-100" name="payment_status">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <div class="d-flex flex-column flex-sm-row gap-2">
                                            ...
                                            <a href="{{ route('reports.purchasing.payment-status') }}" class="btn btn-light btn-active-light-primary flex-grow-1 flex-sm-grow-0">
