                ...
                <form id="kt_modal_edit_payment_method_form{{ $paymentMethod->id }}" class="form">
                    ...
                    <div class="row g-9 mb-8">
                        <div class="col-md-12">
                            ...
                            <select class="form-select form-select-solid" name="location_id[]" id="locationSelect{{ $paymentMethod->id }}" multiple data-control="select2" data-close-on-select="false" data-placeholder="{{__('payments.select_locations')}}" data-allow-clear="true">
                                @if(isset($locations) && $locations->count() > 0)
                                    @php
                                        $selectedLocations = $paymentMethod->location_id ?? [];
                                    @endphp
                            ...
                            <div id="location_id{{ $paymentMethod->id }}"></div>
