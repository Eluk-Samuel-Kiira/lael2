...
<div class="modal fade" id="editProductCategory{{ $category->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-850px">
        <div class="modal-content">
            <div class="modal-header" id="kt_modal_add_currency">
                <h2 class="fw-bold">{{__('pagination.product_category_edit')}}- {{ $category->name }}</h2>
            ...
            <div class="modal-body px-5 my-7">
                <form id="kt_ecommerce_edit_product_category_form{{ $category->id }}" class="form">
                    @csrf
                    @method('PUT')
                    <div class="text-center pt-10">
                        ...
                        <button onclick="editProductCategoryInstanceLoop({{$category->id }})" id="editProductCategoryButton{{ $category->id }}" type="button" class="btn btn-primary">
