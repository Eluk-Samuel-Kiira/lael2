                ...
                <div class="w-100 w-sm-250px">
                    <div class="input-group input-group-solid">
                        ...
                        <input type="text" 
                               ...
                               placeholder="{{__('auth._search')}} {{__('pagination._product')}}"
                               onkeyup="searchTable(this.value, 'kt_table_users')">
                    </div>
                </div>

                @can('create product')
                <button type="button" class="btn btn-primary flex-shrink-0" data-bs-toggle="modal" data-bs-target="#kt_modal_add_product">
