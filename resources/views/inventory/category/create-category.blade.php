    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header" id="kt_modal_add_department">
                <h2 class="fw-bold">{{__('auth._create')}} {{__('pagination._category')}}</h2>
            ...
            <div class="modal-body px-5 my-7">
                <form id="kt_modal_add_category_form" class="form">
                    @csrf
                    <div class="text-center pt-10">
                        ...
                        <button type="reset" class="btn btn-light me-3" id="discardCategoryButton" data-bs-dismiss="modal">{{__('auth._discard') }}</button>
                        
                        <button 
                            id="submitCategoryButton" 
                            type="button" 
                            class="btn btn-primary"
                            onclick="submitCategoryForm('kt_modal_add_category_form', 'submitCategoryButton', '{{ route('category.store') }}', 'POST', 'discardCategoryButton')">
